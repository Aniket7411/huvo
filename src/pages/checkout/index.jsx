...
export default function CheckOut() {
  ...
  return (
    <>
      ...
      {
        loginStatus === null ? <CheckoutWithoutLogin /> : <div>
                    ...
                    <div className="md:flex gap-6">
                      <div className="md:w-8/12">
                        ...
                        {Object.keys(cartProducts).map((key, i) => {
                          return (
                            <div
                              className="bg-white rounded-xl shadow-sm p-4 mb-4 border border-gray-200 relative transition-all hover:shadow-md"
                              key={i}
                            >
                              {/* Remove button */}
                              <button
                                className="absolute top-3 right-3 p-1 rounded-full bg-gray-100 hover:bg-red-100 text-gray-500 hover:text-red-600 transition-colors"
                                  ...
                                  <div className="flex items-center gap-2 mt-3">
                                    <span className="text-lg font-bold text-gray-900 flex items-center">
                                      ...
                                      {Math.floor(
                                        ...
                                        (cartProducts[key].discount / 100) * cartProducts[key].price
                                      )}
                                    </span>
                                    {cartProducts[key].discount > 0 && (
